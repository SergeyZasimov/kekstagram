...
const createMessageIndex = getRandomInteger(1, messages.length - 1, false);
...
const createMockPhotos = () => ({
  ...
  description:
    'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium aliquid cumque ex, magnam placeat ratione?',
  likes: createLikes(),
